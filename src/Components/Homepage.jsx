        ...
        <section className="parts" id="parts">
          ...
          <div className="parts-container container">
            <div className="box">
              ...
              <Link to="/applist" className="btn">Buy now</Link>
              <Link to="/door" className="details">View Details</Link>
            </div>
            <div className="box">
              ...
              <Link to="/applist" className="btn">Buy now</Link>
              <Link to="/engine" className="details">View Details</Link>
            </div>
            <div className="box">
              ...
              <Link to="/applist" className="btn">Buy now</Link>
              <Link to="/battery" className="details">View Details</Link>
            </div>
            <div className="box">
              ...
              <Link to="/applist" className="btn">Buy now</Link>
              <Link to="/alternator" className="details">View Details</Link>
            ...
            <div className="box">
              ...
              <Link to="/applist" className="btn">Buy now</Link>
              <Link to="/mirror" className="details">View Details</Link>
              </div>
            <div className="box">
              ...
              <Link to="/applist" className="btn">Buy now</Link>
              <Link to="/wheel" className="details">View Details</Link>
            </div>
          </div>
        </section>
